...
public class FilterWithReinitialiser {
    private AppiumDriver<AndroidElement> driver;

    @BeforeEach
    public void setup() throws IOException {
        //   driver = BasicSauceLabsConfiguration.setup();
        //driver = BrowserstackBuilder.buildDriver("FilterWithReinitialiser");
        driver = AndroidDriverBuilder.buildDriver();
    }

    @Test
    @DisplayName("it should be able to reset all the filters")
    public void userLogin() throws InterruptedException {
        ...
        //Click on filter
        AndroidElement filterButton = (AndroidElement) new WebDriverWait(driver, 300).until(
                ExpectedConditions.presenceOfElementLocated(MobileBy.id("com.decathlon.quechuafinder:id/textFilter"))
        );
        filterButton.click();
        ...
        //Click on Activite
        AndroidElement activiteButton = (AndroidElement) new WebDriverWait(driver, 300).until(
                ExpectedConditions.presenceOfElementLocated(MobileBy.id("com.decathlon.quechuafinder:id/textFilter"))
        );
        ...
        //Click on Difficulte
        AndroidElement difficulteButton = (AndroidElement) new WebDriverWait(driver, 300).until(
                ExpectedConditions.presenceOfElementLocated(MobileBy.id("com.decathlon.quechuafinder:id/textFilter"))
        );
        difficulteButton.click();
        ...
        System.out.println("Filter is Reinitialise Successfully");
        Thread.sleep(5000);
